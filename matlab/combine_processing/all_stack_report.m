...
for j = 0:17
    ...
    out_lin_x = filloutliers(joint_pos(:,1),'linear', 'movmedian', outliar_win_x(limb_select));
    out_lin_y = filloutliers(joint_pos(:,2),'linear', 'movmedian', outliar_win_y(limb_select));
